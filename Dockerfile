...
RUN tensorflow/tools/ci_build/builds/configured CPU \
	bazel build -c opt --copt=-mavx --copt=-mavx2 --copt=-mfma --copt=-mfpmath=both --copt=-msse4.1 --copt=-msse4.2 -k --cxxopt="-D_GLIBCXX_USE_CXX11_ABI=0"  --jobs 1 --local_resources 6000,4.0,1.0  tensorflow/tools/pip_package:build_pip_package && \
